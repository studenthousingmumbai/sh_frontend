...
const navigation = {
    ...
    social: [
      ...
      },
      {
        ...
        icon: (props) => (
          <svg viewBox="-21 -117 682.66672 682" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="w-6 h-6">
  ...
  export default function Example() {
    return (
      <footer className="bg-[#232728] " aria-labelledby="footer-heading">
        ...
        <div className="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
                ...
                <div>
                  ...
                  <ul role="list" className="mt-4 space-y-4">
                    {navigation.solutions.map((item) => (
                      <li key={item.name}>
                        <Link href={item.href}>
                          <a className="text-base text-gray-300 hover:text-gray-100">
                            {item.name}
                          </a>
                        </Link>
                      </li>
          ...
          <div className="mt-8 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between">
            ...
            <p className="mt-8 text-base text-gray-300 md:order-1 md:mt-0">
              &copy; 2023 Student Housing, Ltd. All rights reserved.
            </p>
          </div>
        </div>
      </footer>

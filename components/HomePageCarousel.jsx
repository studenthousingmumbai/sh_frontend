...
const FlowBiteCarousel = dynamic(
  () => import("flowbite").then((module) => module.FlowBiteCarousel),
  { ssr: false }
);
...
const HomepageCarousel = () => {
  ...
  return (
    <div className="relative flex w-full lg:w-2/3 h-1/2 lg:h-full mr-5 truncate">
      ...
      >
        <div
          className="z-1 hidden duration-700 ease-in-out rounded-lg"
          data-carousel-item
        >
          <img
            src="/left_banner.png"
      ...
      <div className="absolute hidden lg:grid grid-cols justify-center items-center bottom-5 left-5 p-6">
        <div className="font-bold text-6xl text-white uppercase px-3">
          your home
        </div>
        <div className="font-bold text-6xl text-white uppercase text-center">
          away from
        </div>
        <div className="font-bold text-[125px] text-[#ffcc00] leading-[110px] uppercase">
          home
        </div>
        <Link href="/listings" legacyBehavior>
          <button className="font-bold bg-[#088b05] text-[26px] mt-3 py-1 px-6 text-white uppercase rounded-[30px]">
            explore now
          </button>
        </Link>
      </div>
      ...
      <div className="absolute flex lg:hidden flex-col justify-center items-center w-full h-full text-center p-6">
        <div className="font-bold text-4xl sm:text-5xl text-white uppercase">
          your home
        </div>
        <div className="font-bold text-4xl sm:text-5xl text-white uppercase">
          away from
        </div>
        <div className="font-bold text-7xl sm:text-8xl text-[#ffcc00] uppercase">
          home
        </div>
        <Link href="/listings" legacyBehavior>
          <button className="font-bold bg-[#088b05] py-1 px-8 xs:px-10 sm:px-12 md:px-14 text-xl sm:text-2xl text-white uppercase rounded-[30px]">
            explore now
          </button>
        </Link>
      </div>

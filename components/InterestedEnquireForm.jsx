...
export default function InterestedEnquireForm({ title, subTitle, image }) {
  ...
  return (
    <div className="relative h-auto py-16  bg-[linear-gradient(to_left,#F8C14C,#F8C14C33)] flex flex-col gap-4 lg:flex-row responsiveCenterPadding">
      ...
      {/* Text Content */}
      <div className="lg:w-1/2  flex flex-col justify-center items-start gap-6 order-2 lg:order-1 z-10">
        {/* Title */}
      ...
      {/* Image Section */}
      <div className="lg:w-1/2 w-full flex flex-col justify-center items-center overflow-hidden order-1 lg:order-2 z-20">

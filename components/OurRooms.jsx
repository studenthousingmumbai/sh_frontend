    ...
    <div className="flex flex-col responsiveCenterPadding gap-6 ">
      ...
      <div className="flex  flex-col md:flex-row gap-6">
        ...
        <div className="w-full md:w-7/12 font-[400] text-lg leading-[150%]">
          ...
          nunc et libero finibus interdum. Nam augue urna, dapibus et
          consectetur sed, ullamcorper in nunc. Vestibulum maximus nunc nec arcu
          egestas, congue sollicitudin nibh pellentesque. Praesent porttitor
          nibh id velit gravida, sit amet vehicula dui dictum. Nullam ornare
          quam sed enim volutpat, vel posuere sem porta. Fusce tempus, velit id
          condimentum mollis, libero est maximus diam, luctus tristique orci
          arcu vulputate erat. Nulla fermentum nulla ac rutrum finibus. Morbi in

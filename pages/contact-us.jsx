    ...
    return (
        <> 
            <Head> 
                ...
                <meta name='description' content='Student housing provides hostels near NMIMS, Mumbai a great locality in Juhu, Vile Parle. With our in house facilities, students can focus on their studies without any domestic chores worries.'/>
            </Head>
            <Layout> 
                <div className="relative flex justify-center bg-gray-100 items-center my-auto h-[500px] ">
                    <img className='w-full h-full object-cover' src="/contact-bg.jpeg" alt="locations" />

           ...
           <div className="relative flex justify-center bg-gray-100 items-center my-auto h-[500px] ">
            ...
            <div className="relative bg-white">
                ...
                <div className="relative mx-auto max-w-7xl lg:grid lg:grid-cols-5 h-full">
                    <div className="bg-gray-50 py-16 px-4 sm:px-6 lg:col-span-2 lg:px-8 lg:py-8 xl:pr-12">
                        <div className="mx-auto max-w-lg">
                            <h2 className="font-bold text-2xl lg:text-2xl lg1:text-2xl text-start lg:text-start text-[#FBCF5F]">Student Housing Ganga Niwas - Boys Accommodation</h2>
                ...
                <div className="relative mx-auto max-w-7xl lg:grid lg:grid-cols-5 h-full">
                    <div className="bg-gray-50 py-16 px-4 sm:px-6 lg:col-span-2 lg:px-8 lg:py-8 xl:pr-12">
                        <div className="mx-auto max-w-lg">
                            <h2 className="font-bold text-2xl lg:text-2xl lg1:text-2xl text-start lg:text-start text-[#FBCF5F]">Student Housing Anand- Boys Accommodation</h2>

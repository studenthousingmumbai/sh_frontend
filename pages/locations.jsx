        ...
        <Layout> 
            <div className="relative bg-white">
                ...
                <div className="relative mx-auto max-w-7xl lg:grid lg:grid-cols-5 h-full">
                    <div className="bg-gray-50 py-16 px-4 sm:px-6 lg:col-span-2 lg:px-8 lg:py-8 xl:pr-12">
                        <div className="mx-auto max-w-lg">
                            <h2 className="font-bold text-3xl lg:text-3xl lg1:text-3xl text-start lg:text-start text-[#FBCF5F]">Student Housing Ganga Niwas - Boys Accommodation</h2>
                    ...
                    <div className="bg-white py-16 px-4 sm:px-6 lg:col-span-3 lg:py-8 lg:px-8 xl:pl-12">
                        <div className="mx-auto max-w-lg">
                            <h2 className="font-bold text-3xl lg:text-3xl lg1:text-3xl text-start lg:text-start text-[#FBCF5F]">
                ...
                <div className="relative mx-auto max-w-7xl lg:grid lg:grid-cols-5 h-full">
                    <div className="bg-gray-50 py-16 px-4 sm:px-6 lg:col-span-2 lg:px-8 lg:py-8 xl:pr-12">
                        <div className="mx-auto max-w-lg">
                            <h2 className="font-bold text-3xl lg:text-3xl lg1:text-3xl text-start lg:text-start text-[#FBCF5F]">Student Housing Anand- Boys Accommodation</h2>
                     
                            <dl className="mt-8 text-base text-gray-500">
                                <div>
                                    <dt className="sr-only">Postal address</dt>
                                    <dd>
                                        <a href="https://www.google.com/maps/place/Anand+Hostel/@19.1128565,72.8256212,17z/data=!3m1!4b1!4m6!3m5!1s0x3be7c9e85d19534b:0xba01831676d5570b!8m2!3d19.1128565!4d72.8256212!16s%2Fg%2F1thlxxn4?hl=en-GB&authuser=1&entry=ttu" target="_blank" className="mt-6 max-w-3xl text-base text-indigo-500 underline">
                                        Floor 1, 2, 3, 5, Anand Hostel,  8, Gandhigram Rd, Above Dakshinayan, Juhu, Mumbai, Maharashtra 400049
                                        </a>
                                    </dd>
                                </div>
                                <div className="mt-6">
                        ...
                        <div className="mx-auto max-w-lg">
                            ...
                            <dl className="mt-8 text-base text-gray-500">
                                <div>
                                    <dt className="sr-only">Postal address</dt>
                                    <dd>
                                        <a href="https://www.google.com/maps/place/Student+Housing+-+Girls+Hostel+in+Mumbai/@19.1052749,72.8325454,17z/data=!3m1!4b1!4m6!3m5!1s0x3be7c9eed4dff89b:0x245de83cf62eb743!8m2!3d19.1052698!4d72.8351203!16s%2Fg%2F11gk5c32j2?hl=en-GB&authuser=1&entry=ttu" target="_blank" className="mt-6 max-w-3xl text-base text-indigo-500 underline">
                                        Floor 3, 4, 5 Bhav Bindu Building, N S Rd Number 3, JVPD Scheme, Juhu, Mumbai, Maharashtra 400056  
                ...
                <div className="relative mx-auto max-w-7xl lg:grid lg:grid-cols-5 h-full">
                    <div className="bg-gray-50 py-16 px-4 sm:px-6 lg:col-span-2 lg:px-8 lg:py-8 xl:pr-12">
                        <div className="mx-auto max-w-lg">
                            <h2 className="font-bold text-3xl lg:text-3xl lg1:text-3xl text-start lg:text-start text-[#FBCF5F]">Student Housing Madonna- Office</h2>
                        ...
                        <div className="mx-auto max-w-lg">
                            ...
                            <dl className="mt-8 text-base text-gray-500">
                                <div>
                                    <dt className="sr-only">Postal address</dt>
                                    <dd>
                                        <a href="https://www.google.com/maps/place/Shradha+Suman,+37B+Shradha+Suman,+PRESIDENCY+SOCIETY,+N+S+Rd+Number+6,+Friends+Colony,+JVPD+Scheme,+Juhu,+Mumbai,+Maharashtra+400056/@19.1099786,72.8327097,17z/data=!3m1!4b1!4m6!3m5!1s0x3be7c9c3e44a9ed7:0x18d24d9b5cb3a8a1!8m2!3d19.1099786!4d72.8327097!16s%2Fg%2F1pty11jzb?hl=en-GB&authuser=1&entry=ttu" target="_blank" className="mt-6 max-w-3xl text-base text-indigo-500 underline">
                                        2nd floor, Shradha Suman, N S Rd Number 6, Juhu, Mumbai, Maharashtra 400056 
                                        </a>
                                    </dd>
                                </div>
                                <div className="mt-6">
                        ...
                        <div className="mx-auto max-w-lg">
                            ...
                            <dl className="mt-8 text-base text-gray-500">
                                <div>
                                    <dt className="sr-only">Postal address</dt>
                                    <dd>
                                        <a href="https://www.google.com/maps/place/HETALI+SURAJ+SADAN/@19.106025,72.835477,17z/data=!3m2!4b1!5s0x3be7c9c71702fb57:0x9ad2a3e442e521c9!4m6!3m5!1s0x3be7c9c721b14617:0xde253fab605b22fd!8m2!3d19.106025!4d72.835477!16s%2Fg%2F11dxdqkk7s?entry=ttu" target="_blank" className="mt-6 max-w-3xl text-base text-indigo-500 underline">
                                        A-13, 4th Floor, Suraj Sadan, N.S. Road No.3, Juhu Scheme, Vile Parle (W) Mumbai., near Cooper Hospital, Mumbai, Maharashtra 400056 
                                        </a>
                                    </dd>
                                </div>
                                <div className="mt-6">
                        ...
                        <div className="mx-auto max-w-lg">
                            ...
                            <dl className="mt-8 text-base text-gray-500">
                                <div>
                                    <dt className="sr-only">Postal address</dt>
                                    <dd>
                                        <a href="https://www.google.com/maps/place/Kapadia+Apartments/@19.101582,72.8216026,15z/data=!4m10!1m2!2m1!1skapadia!3m6!1s0x3be7c9b82acbac51:0x71d478fc06b8244a!8m2!3d19.101582!4d72.839627!15sCgdrYXBhZGlhkgEQY29ycG9yYXRlX29mZmljZeABAA!16s%2Fg%2F11f33mlt2_?entry=ttu" target="_blank" className="mt-6 max-w-3xl text-base text-indigo-500 underline">
                                        7th floor, Kapadia Apartments, SV Road, near Bank Of India, Navpada, Kamala Nagar, Vile Parle West, Mumbai, Maharashtra 400056
                                        </a>
                                    </dd>
                                </div>
                                <div className="mt-6">
                        ...
                        <div className="mx-auto max-w-lg">
                            ...
                            <dl className="mt-8 text-base text-gray-500">
                                <div>
                                    <dt className="sr-only">Postal address</dt>
                                    <dd>
                                        <a href="https://www.google.com/maps/place/megha+villa/@19.0963785,72.8397306,17z/data=!3m1!4b1!4m6!3m5!1s0x3be7c92a5b2ff957:0x86d0ccd1f969d55a!8m2!3d19.0963785!4d72.8423055!16s%2Fg%2F11g1gt97p1?hl=en-GB&authuser=1&entry=ttu" target="_blank" className="mt-6 max-w-3xl text-base text-indigo-500 underline">
                                        Megha Villa,  LIC Colony, Suresh Colony, Vile Parle West, Mumbai, Maharashtra 400047 
                                        </a>
                                    </dd>
                                </div>
                                <div className="mt-6">

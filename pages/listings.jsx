...
export default function Listings({ all_listings, total, gender }) {
  ...
  const fetchListings = async (gender) => {
    try {
        ...
        {gender ? (
          gender === "male" ? (
            <>
              ...
              <meta
                name="description"
                content="One of the best boy's hostels is provided by Student Housing. Location, Hygiene, and service are three main pillars of the outstanding stay we provide to students in Mumbai."
              />
            </>
          ) : (
            <>
              ...
              <meta
                name="description"
                content="Student housing offers girls' hostel in Mumbai an safe space with 24/7 security and biometric scan entry. Services like delicious three-times-a-day meals, laundry, and drop-off services will also save their valuable time."
              />
            </>
          )
        ) : (
          <>
            <title>
              Book Student Hostel in Mumbai with facilities | Student Housing
            </title>
            <meta
              name="description"
          ...
          <div className="flex lg:hidden bg-white border-b-2 border-gray-200 p-3 gap-3 overflow-y-auto">
            <div className="capitalize text-lg flex items-center">
              <svg
                ...
                strokeWidth={1.5}
                stroke="currentColor"
                className="w-4 h-4 sm:w-6 sm:h-6 text-gray-700 mr-1 sm:mr-2"
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
            ...
            <fieldset className="flex items-center">
              <div>
                <legend className="font-semibold text-sm sm:text-base">
                  Gender
                </legend>
              </div>
